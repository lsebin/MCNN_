...
class ActorAgent(object):
    ...
    def train_model(self, buffer, mean_sum_rewards, abs_max_sum_rewards) :
        ...
        for iter in range(actor_update_iter):
            ...
            # compute advantage to use as weights for "advnatge weighted" regression
            ...
            if self.continuous_agent:
                actor_loss = mse_actor(cur_policy.squeeze(), actions) * weight.reshape(-1) 
            else:
