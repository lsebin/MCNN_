...
from offlinerlkit.modules import ActorProb, Critic, DiagGaussian, MemActor
from offlinerlkit.utils.load_dataset import qlearning_dataset, qlearning_dataset_percentbc_awr
from offlinerlkit.buffer import ReplayBuffer
from offlinerlkit.utils.logger import Logger, make_log_dirs_origin
from offlinerlkit.policy_trainer import MFPolicyTrainer
from offlinerlkit.policy import MemIQLPolicy
...
def train(args=get_args()):
    ...
    critic_v = MemActor(critic_v_backbone, 1, device=args.device, Lipz=args.Lipz, lamda=args.lamda)
    ...
    policy = MemIQLPolicy(
        ...
        adv_normalized=args.adv_normalized,
    )
