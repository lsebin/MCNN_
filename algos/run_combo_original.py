...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="combo_original")
...
def train(args=get_args()):
    ...
    real_buffer.load_dataset_original(dataset)
    ...
    log_dirs = os.path.join('algos/exp', args.task, args.algo_name,  f"seed_{args.seed}", "model")
    load_dynamics_model = True if os.path.exists(log_dirs) else False
